    ...
    <div class="About-Us row">
      <div data-aos="fade-up" data-aos-duration="1500" class="left-about-us col-md-6">
        ...
        <div class="item-absol-about-us">
          <img src="{{route('public/image/about-us3.jpg')}}" width="50%" alt="">
        </div>
      </div>
        ...
        <div class="grid-treatment-price row">
          <div class="left-treatment-price col-md-6" data-aos="fade-up">
            ...
            <ul class="list-group" style="border:none;">
              <li class="list-group-item" style="background: oldlace;">Tâm: Mono Bovis Spa đặt chữ "Tâm" lên hàng đầu, là gốc rễ cho sự phát triển của công ty.  Chúng tôi duy trì đạo đức nghề nghiệp và xã hội ở tiêu chuẩn cao nhất, đảm bảo mang đến những trải nghiệm dịch vụ hoàn hảo nhất. Lòng trung thành của khách hàng chính là kết quả cuối cùng mà Bovis Spa muốn hướng đến.</li>
              <li class="list-group-item" style="background: oldlace;">Tín: Cung cấp dịch vụ thẩm mỹ tiên tiến nhất, nỗ lực hết mình trong việc thực hiện hiệu quả những cam kết về chất lượng sản phẩm và dịch vụ. Hơn hết, Bovis Spa hướng đến mục tiêu trở thành nơi khách hàng gửi gắm niềm tin trên con đường chinh phục sắc đẹp của chính mình.</li>
              <li class="list-group-item" style="background: oldlace;">Thiện: Nỗ lực xây dựng các mối quan hệ với khách hàng, đối tác và đồng nghiệp bằng sự tận tâm, chu đáo và tinh thần nhân văn.  Tích cực đẩy mạnh công tác hỗ trợ khách hàng, xây dựng môi trường làm việc công tâm, thái độ thiện chí trong hợp tác với đối tác.</li>
              <li class="list-group-item" style="background: oldlace;">Trí: Tích cực đổi mới, sáng tạo, chủ động trong công việc là tinh thần làm việc mà Mono Bovis Spa đề cao hướng đến sự chuyên nghiệp và thành thạo tay nghề ở mọi vị trí công việc.</li>
            </ul>
             <p>
    ...
    <div class="container">
      <div class="content-work row ">
        ...
        <div class="right-working col-md-6">
          <h4 class="text-under-h4-HomePage">Thời gian hoạt động</h4>
