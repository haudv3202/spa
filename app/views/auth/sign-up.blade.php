...
{{--          @endif--}}
          ...
          <form action="{{route('sign-up')}}" method="post" >
            ...
            <div class="form-outline ">
              ...
              @if(isset($_SESSION['errors']) && isset($_GET['msg']))
              <span class="error-message">{{$_SESSION['errors']['user']}}</span>
              @endif
            </div>
            <!-- Email input -->
            <div class="form-outline ">
            ...
            <div class="form-outline ">
              ...
              @if(isset($_SESSION['errors']) && isset($_GET['msg']))
                <span class="error-message">{{$_SESSION['errors']['sdt']}}</span>
              @endif
            </div>
            <!-- Password input -->
            <div class="form-outline mb-3">
              ...
              @if(isset($_SESSION['errors']) && isset($_GET['msg']))
                <span class="error-message">{{$_SESSION['errors']['repass']}}</span>
              @endif
            </div>
            <!-- REPassword input -->
            <div class="form-outline mb-3">
