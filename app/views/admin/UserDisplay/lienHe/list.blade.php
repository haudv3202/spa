      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="breadcrumb-main">
            <h4 class="text-capitalize breadcrumb-title">Quản lý liên hệ</h4>
              ...
              <div class="table-responsive">
                <table class="table mb-0 table-borderless">
                  ...
                  <tr class="userDatatable-header">
                    ...
                    <th>
                      <span class="userDatatable-title">Vấn đề</span>
                    </th>
                    <th>
                      <span class="userDatatable-title">Tin nhắn</span>
                    </th>
                    <th>
    ...
    function deletItem(id){
      Swal.fire({
        ...
        if (result.isConfirmed) {
          window.location.href = `{{route('delete-contact/')}}` + id;
        }
      })
    }
  </script>
