                    ...
                    <tr>
                      ...
                      <td>
                        <div class="userDatatable-content">
                          <img src="./public/upload/promotion/{{$value->image}}" alt="" class="rounded" width="50">
                        </div>
                      </td>
                      <td>
                        <div class="userDatatable-content text-truncate" style="max-width: 150px;">
                          <a
                            href="./public/upload/promotion/{{$value->image}}"
                            class="__cf_email__"
                      ...
                      <td>
                        <button class="btn btn-primary btn-default btn-rounded bg-primary text-white " onclick="location.href='{{route('edit-khuyenmai/'.$value->id)}}'"> <i class='bx bx-edit-alt'></i>sửa
                        </button>
                      </td>
                    </tr>
                    @endforeach
