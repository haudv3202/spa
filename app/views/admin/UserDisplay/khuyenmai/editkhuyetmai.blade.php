          ...
          <div class="col-lg-12">
            <div class="card card-default card-md mb-4">
              ...
              <div class="card-body pb-md-50">
                <form action="{{route('edit-khuyenmai/'.$oneData->id)}}" method="post" enctype="multipart/form-data">
                  <div class="row mx-n15">
                    <div class="col-md-4 mb-20 px-15">
                      ...
                      <img src="{{route('./public/upload/promotion/'.$oneData->image)}}"  class="rounded w-100 my-4"  alt="">
                    ...
                    <div class="col-md-4 mb-20 px-15">
                      ...
                      <input type="text" name="link_image" class="form-control ih-medium ip-light radius-xs b-light" value="{{$oneData->link_book	}}"  required>
                    </div>
                  </div>
                  <input class="btn btn-primary px-30" name="sb-poro" type="submit" value="Save">
                </form>
              </div>
            </div>
  ...
  <script>
    Swal.fire(
      ...
      window.setTimeout(function(){
        window.location.href = '{{ route('list_khuyenmai') }}';
      },1000)
  </script>
  @endif
@endpush
