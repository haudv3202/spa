                  ...
                  >
                    ...
                    @foreach($alldata as $key => $value)
                      <tr>
                        ...
                        <td>
                          <div class="userDatatable-content">{{ $value->link }}</div>
                        </td>
                        <td class="d-flex">
                          <button class="btn btn-primary btn-default btn-rounded bg-primary text-white" onclick="location.href='{{ route('social-edit/' .$value->id) }}'"> <i class='bx bx-edit-alt'></i>sửa
                          </button>
                        </td>
                      </tr>
                    @endforeach
